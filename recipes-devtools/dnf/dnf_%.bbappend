...
do_install_append() {
    ...
    install -m 0755 ${WORKDIR}/gumstix-key.service ${D}/${systemd_unitdir}/system/gumstix-key.service
    # create symlink, equivalent to "systemctl enable gumstix-key.service"
    cd ${D}/${sysconfdir}
    ln -s /../${systemd_unitdir}/system/gumstix-key.service systemd/system/multi-user.target.wants/gumstix-key.service
